...
:::info Looking for the v3 setup guide?
LuckyBlock v3 uses a newer configuration format.

<a className="button button--primary" href="./setupv3">Open LuckyBlock setup v3</a>
:::
